...
if ($filtro === 'leidas')  $where = "AND n.estado_envio IN ('Enviada','Fallida')";
            ...
            ?>
                <tr style="<?= $esNueva ? 'background:#fffdf0;border-left:3px solid var(--naranja)' : '' ?>">
                    ...
                    <td>
                        ...
                        <?php elseif ($n['estado_envio'] === 'Enviada'): ?>
                ...
                <tr style="<?= $esNueva ? 'background:#fffdf0' : '' ?>">
                    <td colspan="7" style="padding:4px 14px 10px 44px;font-size:11px;color:var(--gris-text)">
